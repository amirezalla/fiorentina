...
@if ($mostCommentedPosts->isNotEmpty())
                        ...
                        <li class="py-3 border-bottom">
                            <article class="d-flex align-items-start">
                                ...
                                <header class="flex-grow-1">
                                    ...
                                    <p class="h6@if (isset($mostRecentPosts) && $mostRecentPosts->isNotEmpty()) <div class="widget__content" id="most-recent1">
                ...
                @foreach ($mostRecentPosts as $item)
                    <li class="py-3 border-bottom">
                        <article class="d-flex align-items-start">
                            ...
                            {{-- thumb --}}
                            <a href="{{ $item->url }}" class="me-2 flex-shrink-0"
                               style="width:80px;">
                                <img
    ...
    {{-- ── “more news” link (optional) ─────────────────────────────────── --}}
    <div class="text-center py-2" style="background:#8424e3;">
        <a href="" {{-- ← adjust to your news archive route --}} class="fw-semibold text-white text-decoration-none text-uppercase">
            Più notizie <span>&#10140;</span>
        </a>
    </div>
            ...
            <div class="widget__content">
                <ul>
                    @foreach ($mostReadPosts as $post)
                        <li>
                            <article class="post post__widget d-flex align-items-start" style="margin-bottom: 10px;">
                        ...
                        <li>
                            <article class="post post__widget d-flex align-items-start" style="margin-bottom: 10px;">
                                ...
                                <header class="post__header" style="flex: 1;">
                                    ...
                                    {{-- Date --}}
                                    <div class="post__meta" style="font-size: 0.75rem; color: #999; margin-top: 2px;">
                                        <span class="post__created-at">
                                            {{ Theme::formatDate($post->created_at) }}
                                        </span>
                                    </div>
