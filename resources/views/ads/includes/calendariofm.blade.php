...
<div class="col-lg-12 mx-auto">
    <div class="page-sidebar mt-3">
        <section>
            <div class="page-content">
                <div class="post-group">
                    <div class="post-group__header">
                        <h3 class="post-group__title">Calendario Fiorentina Femminile</h3>
                    </div>
                </div>
            </div>
            ...
            @php
                $updateScheduledMessage = App\Http\Controllers\StandingController::fetchCalendarioFM();
            @endphp
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <table class="calendario table table-striped table-responsive" id="sortableTable">
                            ...
                            <tbody>
                                @foreach ($matches = App\Models\CalendarioFM::where('match_date', '>', '2024-08-16 23:00:00 ')->orderBy('match_date', 'asc')->get() as $match)
                                    @php
                                        ...
                                        <td class="text-center">
                                            @if ($match->status != 'SCHEDULED')
                                                ...
                                                <span>
                                                    @php
                                                        $isHomeFiorentina =
                                                            $homeTeam['name'] == 'Fiorentina D' ||
                                                            $homeTeam['name'] == 'Fiorentina D (Ita)' ||
                                                            $homeTeam['name'] == 'Fiorentina D (Ita) *';
                                                        $isAwayFiorentina =
                                                            $awayTeam['name'] == 'Fiorentina D' ||
                                                            $awayTeam['name'] == 'Fiorentina D (Ita)' ||
                                                            $awayTeam['name'] == 'Fiorentina D (Ita) *';
                                                    @endphp
