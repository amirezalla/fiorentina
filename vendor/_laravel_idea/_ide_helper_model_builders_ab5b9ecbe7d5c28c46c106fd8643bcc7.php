...
namespace LaravelIdea\Helper\Botble\Language\Models {
     ...
     * @method LanguageMeta|null firstOrFail($key = null, $operator = null, $value = null)
     * @method LanguageMeta|$this pop(int $count = 1)
     * @method LanguageMeta|null pull($key, $default = null)
     * @method LanguageMeta|null last(callable $callback = null, $default = null)
     * @method LanguageMeta|$this random($number = null, bool $preserveKeys = false)
     * @method LanguageMeta|null sole($key = null, $operator = null, $value = null)
     * @method LanguageMeta|null get($key, $default = null)
     * @method LanguageMeta|null first(callable $callback = null, $default = null)
     ...
     * @method LanguageMeta forceCreateQuietly(array $attributes = [])
     ...
     * @method Language|$this random($number = null, bool $preserveKeys = false)
     ...
     * @method Language forceCreateQuietly(array $attributes = [])
