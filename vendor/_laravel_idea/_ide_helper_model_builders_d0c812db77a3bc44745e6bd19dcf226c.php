...
namespace LaravelIdea\Helper\Botble\Contact\Models {
     ...
     * @method ContactReply|null firstOrFail($key = null, $operator = null, $value = null)
     * @method ContactReply|$this pop(int $count = 1)
     * @method ContactReply|null pull($key, $default = null)
     * @method ContactReply|null last(callable $callback = null, $default = null)
     * @method ContactReply|$this random($number = null, bool $preserveKeys = false)
     * @method ContactReply|null sole($key = null, $operator = null, $value = null)
     * @method ContactReply|null get($key, $default = null)
     * @method ContactReply|null first(callable $callback = null, $default = null)
     ...
     * @method ContactReply forceCreateQuietly(array $attributes = [])
     ...
     * @method Contact|$this random($number = null, bool $preserveKeys = false)
