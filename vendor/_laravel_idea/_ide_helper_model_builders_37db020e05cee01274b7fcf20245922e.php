...
namespace LaravelIdea\Helper\Botble\Dashboard\Models {
     ...
     * @method DashboardWidgetSetting|null firstOrFail($key = null, $operator = null, $value = null)
     * @method DashboardWidgetSetting|$this pop(int $count = 1)
     * @method DashboardWidgetSetting|null pull($key, $default = null)
     * @method DashboardWidgetSetting|null last(callable $callback = null, $default = null)
     * @method DashboardWidgetSetting|$this random($number = null, bool $preserveKeys = false)
     * @method DashboardWidgetSetting|null sole($key = null, $operator = null, $value = null)
     * @method DashboardWidgetSetting|null get($key, $default = null)
     * @method DashboardWidgetSetting|null first(callable $callback = null, $default = null)
     ...
     * @method DashboardWidgetSetting forceCreateQuietly(array $attributes = [])
     ...
     * @method DashboardWidget|null firstOrFail($key = null, $operator = null, $value = null)
     * @method DashboardWidget|$this pop(int $count = 1)
     * @method DashboardWidget|null pull($key, $default = null)
     * @method DashboardWidget|null last(callable $callback = null, $default = null)
     * @method DashboardWidget|$this random($number = null, bool $preserveKeys = false)
     * @method DashboardWidget|null sole($key = null, $operator = null, $value = null)
     * @method DashboardWidget|null get($key, $default = null)
     * @method DashboardWidget|null first(callable $callback = null, $default = null)
     ...
     * @method DashboardWidget forceCreateQuietly(array $attributes = [])
