...
namespace LaravelIdea\Helper\Botble\Menu\Models {
     ...
     * @method MenuLocation|null firstOrFail($key = null, $operator = null, $value = null)
     * @method MenuLocation|$this pop(int $count = 1)
     * @method MenuLocation|null pull($key, $default = null)
     * @method MenuLocation|null last(callable $callback = null, $default = null)
     * @method MenuLocation|$this random($number = null, bool $preserveKeys = false)
     * @method MenuLocation|null sole($key = null, $operator = null, $value = null)
     * @method MenuLocation|null get($key, $default = null)
     * @method MenuLocation|null first(callable $callback = null, $default = null)
     ...
     * @method MenuLocation forceCreateQuietly(array $attributes = [])
     ...
     * @method MenuNode|null firstOrFail($key = null, $operator = null, $value = null)
     * @method MenuNode|$this pop(int $count = 1)
     * @method MenuNode|null pull($key, $default = null)
     * @method MenuNode|null last(callable $callback = null, $default = null)
     * @method MenuNode|$this random($number = null, bool $preserveKeys = false)
     * @method MenuNode|null sole($key = null, $operator = null, $value = null)
     * @method MenuNode|null get($key, $default = null)
     * @method MenuNode|null first(callable $callback = null, $default = null)
     ...
     * @method MenuNode forceCreateQuietly(array $attributes = [])
     ...
     * @method Menu|$this random($number = null, bool $preserveKeys = false)
     ...
     * @method Menu forceCreateQuietly(array $attributes = [])
