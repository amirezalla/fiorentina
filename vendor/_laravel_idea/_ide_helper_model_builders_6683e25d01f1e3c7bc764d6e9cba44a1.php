...
namespace LaravelIdea\Helper\Botble\Media\Models {
     ...
     * @method MediaFile|null firstOrFail($key = null, $operator = null, $value = null)
     * @method MediaFile|$this pop(int $count = 1)
     * @method MediaFile|null pull($key, $default = null)
     * @method MediaFile|null last(callable $callback = null, $default = null)
     * @method MediaFile|$this random($number = null, bool $preserveKeys = false)
     * @method MediaFile|null sole($key = null, $operator = null, $value = null)
     * @method MediaFile|null get($key, $default = null)
     * @method MediaFile|null first(callable $callback = null, $default = null)
     ...
     * @method _IH_MediaFile_QB whereAlt($value)
     ...
     * @method MediaFile forceCreateQuietly(array $attributes = [])
     ...
     * @method MediaFolder|null firstOrFail($key = null, $operator = null, $value = null)
     * @method MediaFolder|$this pop(int $count = 1)
     * @method MediaFolder|null pull($key, $default = null)
     * @method MediaFolder|null last(callable $callback = null, $default = null)
     * @method MediaFolder|$this random($number = null, bool $preserveKeys = false)
     * @method MediaFolder|null sole($key = null, $operator = null, $value = null)
     * @method MediaFolder|null get($key, $default = null)
     * @method MediaFolder|null first(callable $callback = null, $default = null)
     ...
     * @method _IH_MediaFolder_QB whereColor($value)
     ...
     * @method MediaFolder forceCreateQuietly(array $attributes = [])
     ...
     * @method MediaSetting|null firstOrFail($key = null, $operator = null, $value = null)
     * @method MediaSetting|$this pop(int $count = 1)
     * @method MediaSetting|null pull($key, $default = null)
     * @method MediaSetting|null last(callable $callback = null, $default = null)
     * @method MediaSetting|$this random($number = null, bool $preserveKeys = false)
     * @method MediaSetting|null sole($key = null, $operator = null, $value = null)
     * @method MediaSetting|null get($key, $default = null)
     * @method MediaSetting|null first(callable $callback = null, $default = null)
     ...
     * @method MediaSetting forceCreateQuietly(array $attributes = [])
