...
namespace LaravelIdea\Helper\Botble\ACL\Models {
     ...
     * @method Activation|null firstOrFail($key = null, $operator = null, $value = null)
     * @method Activation|$this pop(int $count = 1)
     * @method Activation|null pull($key, $default = null)
     * @method Activation|null last(callable $callback = null, $default = null)
     * @method Activation|$this random($number = null, bool $preserveKeys = false)
     * @method Activation|null sole($key = null, $operator = null, $value = null)
     * @method Activation|null get($key, $default = null)
     * @method Activation|null first(callable $callback = null, $default = null)
     ...
     * @method Activation forceCreateQuietly(array $attributes = [])
     ...
     * @method Role|$this random($number = null, bool $preserveKeys = false)
     ...
     * @method Role forceCreateQuietly(array $attributes = [])
     ...
     * @method UserMeta|null firstOrFail($key = null, $operator = null, $value = null)
     * @method UserMeta|$this pop(int $count = 1)
     * @method UserMeta|null pull($key, $default = null)
     * @method UserMeta|null last(callable $callback = null, $default = null)
     * @method UserMeta|$this random($number = null, bool $preserveKeys = false)
     * @method UserMeta|null sole($key = null, $operator = null, $value = null)
     * @method UserMeta|null get($key, $default = null)
     * @method UserMeta|null first(callable $callback = null, $default = null)
     ...
     * @method UserMeta forceCreateQuietly(array $attributes = [])
