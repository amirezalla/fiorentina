...
namespace LaravelIdea\Helper\Botble\AuditLog\Models {
     ...
     * @method AuditHistory|null firstOrFail($key = null, $operator = null, $value = null)
     * @method AuditHistory|$this pop(int $count = 1)
     * @method AuditHistory|null pull($key, $default = null)
     * @method AuditHistory|null last(callable $callback = null, $default = null)
     * @method AuditHistory|$this random($number = null, bool $preserveKeys = false)
     * @method AuditHistory|null sole($key = null, $operator = null, $value = null)
     * @method AuditHistory|null get($key, $default = null)
     * @method AuditHistory|null first(callable $callback = null, $default = null)
     ...
     * @method AuditHistory forceCreateQuietly(array $attributes = [])
