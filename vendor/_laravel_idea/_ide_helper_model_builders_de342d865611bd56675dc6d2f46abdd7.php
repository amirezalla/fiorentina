<?php //42fd3234716070f262607e7a0c86801c
/** @noinspection all */
...
namespace LaravelIdea\Helper {
     ...
     * @method $this rightJoinSub(\Closure|Builder|\Illuminate\Database\Query\Builder|string $query, string $as, \Closure|Expression|string $first, null|string $operator = null, Expression|null|string $second = null)
     ...
     * @method $this orWhereAll(string[] $columns, string $operator = null, $value = null)
     ...
     * @method $this joinSub(\Closure|Builder|\Illuminate\Database\Query\Builder|string $query, string $as, \Closure|Expression|string $first, null|string $operator = null, Expression|null|string $second = null, string $type = 'inner', bool $where = false)
     ...
     * @method $this leftJoinLateral(\Closure|Builder|\Illuminate\Database\Query\Builder|string $query, string $as)
     ...
     * @method $this orWhereAny(string[] $columns, string $operator = null, $value = null)
     ...
     * @method $this whereAll(string[] $columns, $operator = null, $value = null, string $boolean = 'and')
     ...
     * @method $this insertOrIgnoreUsing(array $columns, \Closure|Builder|\Illuminate\Database\Query\Builder|string $query)
     ...
     * @method $this leftJoinSub(\Closure|Builder|\Illuminate\Database\Query\Builder|string $query, string $as, \Closure|Expression|string $first, null|string $operator = null, Expression|null|string $second = null)
     ...
     * @method $this whereAny(string[] $columns, string $operator = null, $value = null, string $boolean = 'and')
     ...
     * @method $this joinLateral(\Closure|Builder|\Illuminate\Database\Query\Builder|string $query, string $as, string $type = 'inner')
