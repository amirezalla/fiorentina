<?php //e62763f52df010016cd2c38bcddfb807
/** @noinspection all */
...
namespace Botble\ACL\Models {
     ...
     * @property Carbon|null $created_at
     * @property Carbon|null $updated_at
     * @property null $first_name
     * @property null $last_name
     ...
     * @property-read bool $activated attribute
     * @property-read string $avatar_url attribute
     * @property string $name attribute
     * @property null|string $url attribute
     ...
     * @property _IH_UserMeta_C|UserMeta[] $meta
     * @property-read int $meta_count
     * @method HasMany|_IH_UserMeta_QB meta()
     * @property _IH_MetaBox_C|MetaBox[] $metadata
     * @property-read int $metadata_count
     * @method MorphToMany|_IH_MetaBox_QB metadata()
